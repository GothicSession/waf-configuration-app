  ...
  public login(
    ...
    return this.httpClient.post<any>(
      ...
      tap((response: LoginResponseInterface) => {
        if (response?.cookies) {
          if (response.cookies.wafservice_session) {
            this._cookieService.set('wafservice_session', response.cookies.wafservice_session);
          }
          if (response.cookies.wafservice_user) {
            this._cookieService.set('wafservice_user', response.cookies.wafservice_user);
          }
        }
      })
    );
